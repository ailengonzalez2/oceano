...
Usage: python3 scripts/prepare-fish-model.py /path/to/school_of_fish.glb
Geometry, skinning and swimming tracks are preserved byte-for-byte.
"""
import json
import struct
import sys
...
model['asset'].setdefault('extras', {})['adaptation'] = 'Diffuse textures retained; legacy specular/glossiness materials approximated with nonmetallic roughness 0.55. Unused specular textures removed. Original geometry and swimming animation preserved.'
...
output = Path('public/models/school_of_fish.glb')
